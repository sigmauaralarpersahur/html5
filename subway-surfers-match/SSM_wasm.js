...
function _HtmlLoaderLibrary_Hide() {
    Loader.hide()
}

function _HtmlLoaderLibrary_SetProgress(value) {
...
function _HtmlLoaderLibrary_SetText(value) {
    Loader.setText(UTF8ToString(value))
}

function _HtmlLoaderLibrary_Show() {
    Loader.show()
}
var wasmTableMirror = [];
var wasmTable;
...
function _PokiSdkJs_Measure(category, action, label) {
...
var FS = {
    ...
    quit() {
        ...
        var _iterator2 = _createForOfIteratorHelper(FS.streams),
            _step2;
        try {
...
var JSEvents = {
    ...
    deferCall(targetFunction, precedence, argsList) {
        ...
        var _iterator3 = _createForOfIteratorHelper(JSEvents.deferredCalls),
            _step3;
        try {
    ...
    runDeferredCalls() {
        ...
        JSEvents.deferredCalls = [];
        var _iterator4 = _createForOfIteratorHelper(deferredCalls),
            _step4;
        try {
...
var MainLoop = {
    ...
    runIter(func) {
        if (ABORT) return;
        var _iterator5 = _createForOfIteratorHelper(MainLoop.preMainLoop),
            _step5;
        try {
        ...
        var _iterator6 = _createForOfIteratorHelper(MainLoop.postMainLoop),
            _step6;
        try {
    ...
    if (!ret) {
        switch (name_) {
            ...
            case 7938:
                ...
                if (GL.currentContext.version >= 2) glVersion = "OpenGL ES 3.0 (".concat(webGLVersion, ")");
...
MainLoop.init();
for (var _i3 = 0; _i3 < 32; ++_i3) tempFixedLengthArray.push(new Array(_i3));
...
var wasmImports = {
    ni: _HtmlLoaderLibrary_Hide,
    mi: _HtmlLoaderLibrary_SetProgress,
    li: _HtmlLoaderLibrary_SetText,
    ki: _HtmlLoaderLibrary_Show,
    ji: _PokiSdkJs_AddParameterForURL,
    ii: _PokiSdkJs_CaptureError,
    hi: _PokiSdkJs_CommercialBreak,
    gi: _PokiSdkJs_GameplayStart,
    fi: _PokiSdkJs_GameplayStop,
    ei: _PokiSdkJs_GetURLParam,
    di: _PokiSdkJs_InternalCaptureError,
    ci: _PokiSdkJs_IsAdBlocked,
    bi: _PokiSdkJs_Measure,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
    return (_wasm_call_ctors = wasmExports["oi"])()
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function() {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["pi"])()
};
var _main = Module["_main"] = function(a0, a1) {
    return (_main = Module["_main"] = wasmExports["qi"])(a0, a1)
};
var _malloc = Module["_malloc"] = function(a0) {
    return (_malloc = Module["_malloc"] = wasmExports["ri"])(a0)
};
var _free = Module["_free"] = function(a0) {
    return (_free = Module["_free"] = wasmExports["si"])(a0)
};
var _htonl2 = function _htonl(a0) {
    return (_htonl2 = wasmExports["ui"])(a0)
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function(a0) {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["vi"])(a0)
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function() {
    return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["wi"])()
};
var _htons2 = function _htons(a0) {
    return (_htons2 = wasmExports["xi"])(a0)
};
var _ntohs2 = function _ntohs(a0) {
    return (_ntohs2 = wasmExports["yi"])(a0)
};
var _JSWriteDump = Module["_JSWriteDump"] = function(a0) {
    return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["zi"])(a0)
};
